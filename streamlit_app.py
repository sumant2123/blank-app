...
def get_conversation_chain(vectordb):
    ...
    st.write('tokenizer loaded sucessfully')
    ...
    # Create a conversational retrieval chain using Hugging Face's AutoModel
    ...
    print("Conversational Chain created using Hugging Face model with vector store")
